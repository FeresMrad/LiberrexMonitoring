        ...
        datasets: [
          {
            ...
            data: response.data.map(item => item.bytes_per_sec)
          },
          {
    ...
    if ((data.measurement === 'apache_raw' || data.measurement === 'apache_interval') && data.host === props.host) {
      ...
      if (timeIndex === -1) {
        ...
        if (data.measurement === 'apache_raw' && data.fields.bytes_per_sec !== undefined) {
          // For bytes_per_sec, update dataset 0
          currentDatasets[0] = {
            ...currentDatasets[0],
            data: [...currentDatasets[0].data, data.fields.bytes_per_sec]
          };
          ...
          // For interval_bytes_per_sec, update dataset 1
          currentDatasets[1] = {
            ...currentDatasets[1],
            data: [...currentDatasets[1].data, data.fields.interval_bytes_per_sec]
          };
